	...
	<nav class="fixed w-full z-50 transition-all duration-300 {isScrolled ? 'bg-white/90 backdrop-blur-md shadow-sm' : 'bg-transparent'}"
		...
		<div class="container">
			<div class="flex justify-between items-center h-16 md:h-20">
				<!-- Logo -->
				<a href="{base}/" class="flex items-center space-x-3 group" aria-label="Vigilia AI Home">
					<div class="relative w-8 h-8 md:w-10 md:h-10 flex items-center justify-center">
						<img src="{base}/v-logo.svg" alt="" class="h-7 w-7 md:h-9 md:w-9 transition-transform duration-300 group-hover:scale-110" />
